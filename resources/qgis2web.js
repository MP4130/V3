...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:2177',
            //extent: [6567515.000000, 5564013.000000, 6580542.000000, 5571881.500000],
            units: 'm'
        })
    })
});
...
map.getView().fit([5798091.037243, 5005548.684534, 7369716.037243, 6289358.021883], map.getSize());
